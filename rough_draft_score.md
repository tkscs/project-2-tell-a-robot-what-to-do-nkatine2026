...
https://github.com/tkscs/project-2-tell-a-robot-what-to-do-nkatine2026/pull/1
...
* [ 0 / 10 ] Robot can move, and code runs without errors in simulator
* [ 0 / 5 ] Robot does not crash into walls

Control Flow - If/Elif/Else (15 points):

* [ 0 / 5 ] At least one if/elif/else chain with 3+ branches
...
* [ 1 / 3 ] Call each of your functions at least once
* [ 1 / 3 ] For each function, include a doc string explaining the API
* [ 1 / 1 ] At least 1 of your functions has at least 1 parameter

Sensors (10 points):

* [ 3 / 5 ] Read a sonar distance at least 5 times
* [ 3 / 5 ] Robot behavior changes based on the sonar values
